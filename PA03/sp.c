Node *Load_Sequence_File(char *Filename){
  ...
  Node *node = malloc(sizeof(Node) * nblocks);
...
Node *createNodes(double numval, double width, double height){
